...
register_command_handler(handler_vote_vote, {1: 'мнение', 2: 'option', 3: '!option'}, ['голосование','мук','все'], 10, 'Для подачи мнения в текущем голосовании.', 'option <мнение>', ['option да'])
register_command_handler(handler_vote_newpoll, {1: 'голосование', 2: 'vote', 3: '!vote'}, ['голосование','мук','все'], 20, 'Создаёт новое голосование или отправляет готовое голосование в текущий чат, если даны мнения.', 'vote [вопрос]', ['vote винды - сакс!', 'vote'])
register_command_handler(handler_vote_polloption, {1: 'пункт', 2: 'voteitem', 3: '!voteitem'}, ['голосование','мук','все'], 20, 'Добавляет пункт (1!) к текущему голосованию.', 'voteitem <твой_пункт>', ['voteitem да'])
register_command_handler(handler_vote_endpoll, {1: 'итоги', 2: 'voteend', 3: '!voteend'}, ['голосование','мук','админ','все'], 20, 'Завершает голование и показывает его резалты.', 'voteend', ['voteend'])
