#===istalismanplugin===
# -*- coding: utf-8 -*-
####### by Als. много сенков уходит dimichxp!!! #######
...
register_command_handler(handler_complaint, {1: 'жалоба', 2: 'compl', 3: '!compl'},  ['мук','все'], 0, 'Пожаловаться на определённый ник по определённой причине. Работает только у меня в привате!', 'compl <ник> <причина>', ['compl Nick7 спам'])
